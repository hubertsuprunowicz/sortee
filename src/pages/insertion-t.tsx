...
import Image from "../data/images/insertion-sort.png"
      ...
      <Wrapper>
        <Flex>
          <div>
            ...
            {displayImage ? (
              <img src={Image} alt="Sortowanie przez wsadzanie"></img>
            ) : (
              <>
                <span>
                ...
                <span>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      elementu większego (jeśli chcemy otrzymać ciąg
                      niemalejący) lub nie znajdziemy się na początku/końcu
...
export default InsertionTheoryPage
